...
\section*{The Bottleneck It Answered}
...
\section*{What a Perceptron Actually Is}
...
\section*{The Convergence Guarantee}
...
\section*{Where the Line Runs Out}
...
Marvin Minsky and Seymour Papert made this observation precisely, and at length, in their 1969 book \emph{Perceptrons}. Their argument was not that Rosenblatt's device was poorly designed or poorly trained. It was a proof: certain functions, XOR chief among them, cannot be represented by a single-layer perceptron at all, regardless of how the weights are set. No amount of additional training data or additional training time closes a gap that is representational rather than statistical. The perceptron is not failing to find the rule. There is no linear rule to find.

\section*{The Bottleneck This Exposes}
